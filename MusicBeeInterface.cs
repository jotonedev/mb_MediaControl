...
namespace MusicBeePlugin
{
    public partial class Plugin
    {
        ...
        public delegate ToolStripItem MB_AddMenuItemDelegate(string menuPath,
            string hotkeyDescription, EventHandler handler);

        public delegate Control MB_AddPanelDelegate(Control panel,
            PluginPanelDock dock);

        public delegate bool MB_AddTreeNodeDelegate(string treePath, string name, Bitmap icon,
            EventHandler openHandler, EventHandler closeHandler);

        public delegate void MB_CreateBackgroundTaskDelegate(ThreadStart taskCallback,
            Form owner);

        public delegate void MB_CreateParameterisedBackgroundTaskDelegate(
            ParameterizedThreadStart taskCallback, object parameters, Form owner);
        ...
        public delegate bool MB_SetPanelScrollableAreaDelegate(Control panel,
            Size scrollArea, bool alwaysShowScrollBar);
